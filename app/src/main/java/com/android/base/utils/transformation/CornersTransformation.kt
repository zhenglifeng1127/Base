...
class CornersTransformation(radius: Int, margin: Int, cornerType: CornerType? = CornerType.ALL) :
    BitmapTransformation() {


    private val version = 1
    private val id = "jp.wasabeef.glide.transformations.CornersTransformation.$version"
    ...
    enum class CornerType {
         ...
         * 圆角的类型枚举
         */
        ALL, BOTTOM, BOTTOM_LEFT, BOTTOM_RIGHT, DIAGONAL_FROM_TOP_LEFT, DIAGONAL_FROM_TOP_RIGHT, LEFT, OTHER_BOTTOM_LEFT, OTHER_BOTTOM_RIGHT, OTHER_TOP_LEFT, OTHER_TOP_RIGHT, RIGHT, TOP, TOP_LEFT, TOP_RIGHT
    }
    ...
    override fun equals(other: Any?): Boolean {
        return when(other){
            is CornersTransformation ->{
                return other.radius == radius && other.diameter == diameter && other.margin == margin && other.cornerType == cornerType
            }
            else -> false
        }
    }
